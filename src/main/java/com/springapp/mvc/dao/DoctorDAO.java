...
public class DoctorDAO {
	...
	public List<Doctor> searchDoctorsByStaffPersonId(int personId) {
		...
		List<Doctor> doctors = jdbcTemplate.query(sql,
				new Object[] { staff_id }, new BeanPropertyRowMapper(
						Doctor.class));
	...
	public List<Doctor> getDoctorsForRevokePatient(int patientId, int doctorId) {
		...
		List<Doctor> doctors = jdbcTemplate.query(sql, new Object[] {
				patientId, doctorId }, new BeanPropertyRowMapper(Doctor.class));
	...
	public List<Doctor> searchDoctorsForGrantByKeyword(int patientId,
			String keyword) {
		...
		List<Doctor> doctors = jdbcTemplate.query(sql, new Object[] {
				patientId, "%" + keyword + "%" }, new BeanPropertyRowMapper(
				Doctor.class));
	...
	public String getDefaultDoctorByPersonId(int personId) {
		...
		int doctor_id = jdbcTemplate
				.queryForInt(sql, new Object[] { personId });
