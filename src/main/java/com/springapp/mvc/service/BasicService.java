...
public class BasicService {
	...
	public List<Map<Integer, Object>> findScheduleByVisit(int type,
			int idNumber, String start, String end) {
		String todayString;
		...
		List<Visit> visits;
		if (type == 1) {
			visits = appointmentDAO.getAppointmentsByDoctorId(idNumber,
					todayString, lastDayString);
		} else {
			visits = appointmentDAO.getAppointmentsByPatientId(idNumber,
					todayString, lastDayString);
		}
	...
	public Date getSchedule(Visit visit, String time) {
		...
		if (timeList.get(1).equals("1")) {
			timeValue = "09:00:00";
		} else if (timeList.get(1).equals("2")) {
			timeValue = "09:30:00";
		} else if (timeList.get(1).equals("3")) {
			timeValue = "10:00:00";
		} else if (timeList.get(1).equals("4")) {
			timeValue = "10:30:00";
		} else if (timeList.get(1).equals("5")) {
			timeValue = "11:00:00";
		} else if (timeList.get(1).equals("6")) {
			timeValue = "11:30:00";
		} else if (timeList.get(1).equals("7")) {
			timeValue = "13:00:00";
		} else if (timeList.get(1).equals("8")) {
			timeValue = "13:30:00";
		} else if (timeList.get(1).equals("9")) {
			timeValue = "14:00:00";
		} else if (timeList.get(1).equals("10")) {
			timeValue = "14:30:00";
		} else if (timeList.get(1).equals("11")) {
			timeValue = "15:00:00";
		} else if (timeList.get(1).equals("12")) {
			timeValue = "15:30:00";
		} else if (timeList.get(1).equals("13")) {
			timeValue = "16:00:00";
		} else {
			timeValue = "16:30:00";
		}
